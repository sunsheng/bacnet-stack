...
本文档说明如何用 CMake 把 bacnet-stack 交叉编译到以下 4 个目标平台。
...
| 3 | Windows x86 (32 位) | MinGW-w64 i686 | msvcrt | 静态 | `build-win32/` |
| 4 | Windows x64 (64 位) | MinGW-w64 x86_64 | msvcrt | 静态 | `build-win64/` |
